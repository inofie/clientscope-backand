...
class UserPinCustomField extends Model
{
     ...
     * @var string
     */
    protected $table = 'user_pin_custom_field';
     ...
     */
    protected $fillable = [
        'user_pin_id', 'custom_field_id', 'value', 'created_at', 'updated_at', 'deleted_at'
    ];
   ...
   */
    ...
    */
    ...
    public static function addCustomFieldValues($user_pin_id,$custom_fields)
    {
