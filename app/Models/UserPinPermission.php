...
class UserPinPermission extends Model
{
    use SoftDeletes, RestModel;

    protected $table = 'user_pin_permission';
     ...
     */
    protected $fillable = [
        'creator_user_id', 'assignee_user_id', 'add', 'view', 'view', 'delete', 'created_at', 'updated_at', 'deleted_at'
    ];
