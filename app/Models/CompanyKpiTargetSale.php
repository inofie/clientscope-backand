...
class CompanyKpiTargetSale extends Model
{
     ...
     * @var string
     */
    protected $table = 'company_kpi_target_sale';
     ...
     */
    protected $fillable = [
        'user_company_id', 'company_sale_plan_id', 'kpi_target_sale_type', 'kpi_group_id', 'target_value',
